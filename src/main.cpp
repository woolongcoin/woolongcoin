...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // WoolongCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "WoolongCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 60;						// WoolongCoin: every 60 minutes
static const int64 nTargetSpacing = 60;								// WoolongCoin: 60 sec
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // WoolongCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal woolongcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WoolongCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "With two days of the 2014 Winter Olympics Games completed, Norway has risen to the top of the medal count leaderboard";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // WoolongCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
